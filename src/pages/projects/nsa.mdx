...
I also created illustrations of the prefectural icons to randomly display on the app's splash screen when launched. Each icon has a weight assigned, allowing certain special icons to appear only for lucky users.
